...
if ( "$ENV{CMAKE_INSTALL_PREFIX}" STREQUAL "")
...
elseif( EXISTS "${ANDROID_TOOLCHAIN_ROOT}/${ANDROID_TOOLCHAIN_MACHINE_NAME}/include/c++/${ANDROID_COMPILER_VERSION}/${ANDROID_TOOLCHAIN_MACHINE_NAME}/bits" )
 ...
 #message("Could not auto detect 'bits' include, adding manually")
 #message(STATUS "/home/jonnenau/dev/toolchain/arm-linux-androideabi/include/c++/4.6.3/arm-linux-androideabi")
 list( APPEND ANDROID_SYSTEM_INCLUDE_DIRS "/home/jonnenau/dev/toolchain/arm-linux-androideabi/include/c++/4.6.3/arm-linux-androideabi" )
endif()
...
# where is the target environment and potential built libs
set( CMAKE_FIND_ROOT_PATH "${ANDROID_TOOLCHAIN_ROOT}/user" "${ANDROID_TOOLCHAIN_ROOT}/user/include" "${ANDROID_TOOLCHAIN_ROOT}/user/lib" "${ANDROID_TOOLCHAIN_ROOT}/user/bin"  "${ANDROID_TOOLCHAIN_ROOT}/bin" "${ANDROID_TOOLCHAIN_ROOT}/${ANDROID_TOOLCHAIN_MACHINE_NAME}" "${CMAKE_INSTALL_PREFIX}" "${CMAKE_INSTALL_PREFIX}/lib" "${CMAKE_INSTALL_PREFIX}/bin" $ENV{PREBUILT} $ENV{PREBUILT}/lib $ENV{PREBUILT}/include "${ANDROID_SYSROOT}")

# only search for libraries and includes in the ndk toolchain.
# NOTE: This means it wont allow to look libs from anywhere else than CMAKE_FIND_ROOT_PATH.
# So it wont mistakenly find them from the host system. If you have android libs somewhere else add them above!
